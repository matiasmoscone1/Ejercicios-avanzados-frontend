...
const UserProfile = () => {
    ...
    return(<div className="w-40 h-25 flex flex-col justify-center items-center gap-2">
        ...
        {state.flagSession && <div className="fixed inset-0 flex justify-center items-center bg-black/50 z-50" onClick={() => closePopUp(e)}>
            <div className="w-1/3 h-1/3 bg-white rounded-md" ref={refPopUp}>
                <span>¿Desea cerrar la sesión?</span>
                <div>
                    <button>Salir</button>
